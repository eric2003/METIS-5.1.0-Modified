...
/**************************************************************************/\
METIS_API(PQT *) FPRFX ## Create(size_t maxnodes)\
{\
  PQT *queue; \
\
...
/**************************************************************************/\
METIS_API(void) FPRFX ## Init(PQT *queue, size_t maxnodes)\
{\
  queue->nnodes = 0;\
...
/**************************************************************************/\
METIS_API(void) FPRFX ## Reset(PQT *queue)\
{\
  gk_idx_t i;\
...
/**************************************************************************/\
METIS_API(void) FPRFX ## Free(PQT *queue)\
{\
...
/**************************************************************************/\
METIS_API(void) FPRFX ## Destroy(PQT *queue)\
{\
  if (queue == NULL) return;\
  FPRFX ## Free(queue);\
...
/**************************************************************************/\
METIS_API(size_t) FPRFX ## Length(PQT *queue)\
{\
  return queue->nnodes;\
}\
\
...
/**************************************************************************/\
METIS_API(int) FPRFX ## Insert(PQT *queue, VT node, KT key)\
{\
  gk_idx_t i, j;\
  gk_idx_t *locator=queue->locator;\
  KVT *heap=queue->heap;\
...
/**************************************************************************/\
METIS_API(int) FPRFX ## Delete(PQT *queue, VT node)\
{\
  gk_idx_t i, j, nnodes;\
  KT newkey, oldkey;\
  gk_idx_t *locator=queue->locator;\
...
/**************************************************************************/\
METIS_API(void) FPRFX ## Update(PQT *queue, VT node, KT newkey)\
{\
  gk_idx_t i, j, nnodes;\
  KT oldkey;\
  gk_idx_t *locator=queue->locator;\
...
/**************************************************************************/\
METIS_API(VT) FPRFX ## GetTop(PQT *queue)\
{\
  gk_idx_t i, j;\
  gk_idx_t *locator;\
  KVT *heap;\
...
/**************************************************************************/\
METIS_API(VT) FPRFX ## SeeTopVal(PQT *queue)\
{\
...
/*! This function returns the key of the top item. The item is not\
    deleted from the queue. */\
/**************************************************************************/\
METIS_API(KT) FPRFX ## SeeTopKey(PQT *queue)\
{\
...
/**************************************************************************/\
METIS_API(KT) FPRFX ## SeeKey(PQT *queue, VT node)\
{\
  gk_idx_t *locator;\
  KVT *heap;\
\
...
/**************************************************************************/\
/*\
METIS_API(VT) FPRFX ## SeeConstraintTop(PQT *queue, KT maxwgt, KT *wgts)\
{\
  gk_idx_t i;\
\
  if (queue->nnodes == 0)\
...
/**************************************************************************/\
METIS_API(int) FPRFX ## CheckHeap(PQT *queue)\
{\
  gk_idx_t i, j;\
  size_t nnodes;\
  gk_idx_t *locator;\
